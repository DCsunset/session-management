...
impl TokenServer {
    pub fn new(&mut self) -> TokenServer {
        TokenServer {
            nodes: Mutex::new(vec!["redis://127.0.0.1:7000/".to_string(), "redis://127.0.0.1:7001/".to_string(), "redis://127.0.0.1:7002/".to_string(), "redis://127.0.0.1:7003/".to_string(), "redis://127.0.0.1:7004/".to_string(), "redis://127.0.0.1:7005/".to_string()]),
            client: Mutex::new(redis::cluster::ClusterClient::open(self.nodes.get_mut().unwrap().to_vec()).unwrap())
        }
    }
...
async fn main() -> std::io::Result<()> {
    let original_nodes = vec!["redis://127.0.0.1:7000/", "redis://127.0.0.1:7001/", "redis://127.0.0.1:7002/", "redis://127.0.0.1:7003/", "redis://127.0.0.1:7004/", "redis://127.0.0.1:7005/"];
